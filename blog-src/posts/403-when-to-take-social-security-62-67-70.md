...
**Meta description:** How to model Social Security claiming ages (62, 67, and 70) in the AI Retirement Income Planner, using the SS Optimizer and phased withdrawals, including the surprising way claiming age interacts with your portfolio.

**Suggested URL slug:** when-to-take-social-security-62-67-70

**Image source base:** social security claiming

**Lead image:** 1

**Image 1 alt:** Editorial illustration of a retiree at a signposted crossroads marked 62, 67, and 70, weighing a smaller check now against a larger check later.

**Image 2 alt:** The SS Optimizer tab showing lifetime Social Security payout and break-even ages across claiming ages from 62 to 70.

**Image 3 alt:** The Social Security claiming age field in the Edit values tab, set to a chosen age.

**Image 4 alt:** A phase card split into two parts where Social Security begins mid-phase, with the later part independently editable.

**Primary keyword:** when to take social security 62 vs 67 vs 70

**Secondary keywords:** social security claiming age, social security break-even age, model social security claiming, delay social security, spousal survivor benefit

**Educational disclaimer:** This article is for general education only. It is not financial, tax, investment, legal, healthcare, Social Security, Medicare, estate, or retirement advice. It explains how to model Social Security claiming ages in planning software. Rules and figures are set by the Social Security Administration and change. Confirm your own estimates at ssa.gov and with qualified professionals before acting.
...
[IMAGE social security claiming 3]
...
[IMAGE social security claiming 2]
...
**Soft CTA:** Want to see the claiming decision play out across a full plan? The interactive demo walks through a sample plan phase by phase, with Social Security timing already modeled.

**Demo CTA:** Open the demo and look at how Social Security changes the income picture when it starts. It shows how portfolio withdrawals can drop the moment those checks begin.

**Product CTA:** The AI Retirement Income Planner models Social Security claiming from 62 to 70, includes an SS Optimizer with break-even analysis, handles both spouses and the survivor scenario, and shows how claiming age interacts with your withdrawals across five phases. One-time purchase, no subscription, no account, and your plan stays in your own browser.

## Internal Links To Add

- Forward links used in body: claim-social-security-at-62-or-wait (005), which-retirement-account-withdraw-from-first (006), how-much-can-i-spend-in-retirement (019), taxes-aca-healthcare-early-retirement (402), survivor-benefits-widows-tax-cliff (203), save-load-compare-retirement-scenarios (401), how-to-set-up-a-retirement-income-plan (400).
- Reciprocal backfills to consider: 005 → this post (its "how to model it" hook) and 203 → this post (higher-earner-delays survivor point).

## Facebook Post Snippets

**Snippet 1:** When to claim Social Security is one of the largest financial decisions you will make, and one of the least obvious. Claim at 62 and the money starts now but is permanently reduced. Wait to 70 and the check is about 77% larger. Here is how to model it for your own numbers.

**Snippet 2:** A surprising result: a bigger Social Security check does not always mean more monthly income. Waiting to 70 means your portfolio funds the bridge years alone, and draining it early can cost more growth than the larger check is worth. Only a plan that models claiming and withdrawals together shows it.

**Snippet 3:** For couples, the higher earner's claiming decision is really about the survivor. When one spouse dies, the survivor keeps the larger of the two benefits. Delaying can buy your spouse a bigger, inflation-adjusted safety net for life.

## Newsletter Summary

When to claim Social Security is one of the largest and least obvious retirement decisions, and this guide shows how to model it. It covers the structural numbers (about a 30% cut at 62, roughly 77% more at 70, break-even in the late 70s to around 80), how to set the claiming age in the planner and enter the right benefit figure, and how the SS Optimizer calculates the lifetime trade-off across every age from 62 to 70. Its most valuable point is that claiming age cannot be separated from your withdrawal strategy: waiting means larger early portfolio withdrawals, so a bigger check does not always mean higher monthly income, a result only visible when both are modeled together, balanced against the real longevity and survivor benefits of waiting. It also covers mid-phase claiming and split phases, and why the higher earner in a couple often waits to protect the survivor.
