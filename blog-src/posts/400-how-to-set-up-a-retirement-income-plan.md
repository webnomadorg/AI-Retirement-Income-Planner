...
**Meta description:** A step-by-step walkthrough for setting up your first retirement income plan in the AI Retirement Income Planner, from the setup wizard and starting balances to fine-tuning income across five phases.

**Suggested URL slug:** how-to-set-up-a-retirement-income-plan

**Image source base:** getting started

**Lead image:** 1

**Image 1 alt:** Editorial illustration of a person at a desk building a phased retirement income timeline on screen, with cards for income, taxes, healthcare, and account balances flowing left to right.

**Image 2 alt:** The planner's Overview tab showing five phase cards side by side, each with net monthly income, estimated tax, healthcare cost, and an ending balance.

**Image 3 alt:** The Quick Setup Wizard open on its first step, asking for current age, retirement age, and starting balances.

**Image 4 alt:** The Edit values tab showing starting balances, growth rates, and income-source fields grouped into sections.

**Image 5 alt:** A single phase card being edited in place, with the tax estimate and an ACA subsidy warning updating live as the withdrawal amount changes.

**Primary keyword:** how to set up a retirement income plan

**Secondary keywords:** retirement income planner tutorial, how to use a retirement planner, retirement plan setup, first retirement plan, retirement phases

**Educational disclaimer:** This article is for general education only. It is not financial, tax, investment, legal, healthcare, Social Security, Medicare, estate, or retirement advice. It explains how to use planning software to model a retirement income plan. Rules, tax law, and costs change. Confirm decisions with qualified professionals and official sources before acting.
...
To model that, the planner divides retirement into [a timeline of connected phases](/blog/retirement-income-timeline-phases.html) rather than treating it as one averaged year. The **Overview** tab shows these as a row of cards, and this is where you will spend most of your time.
...
- **Tax parameters.** Standard deduction, bracket ceilings, and healthcare thresholds live here. These change every year, so it is worth getting current figures before you rely on the numbers. The planner has a built-in workflow for [keeping those rates current](/blog/keeping-your-retirement-plan-current.html) that takes a couple of minutes.
...
1. **Get current tax rates** so the calculations start from accurate figures.
2. **Enter your retirement age and starting balances** for each account.
3. **Enter a rough withdrawal amount per phase** just to get numbers on the screen.
4. **Tweak phase by phase** on the Overview cards, always checking that each phase ends with the balance you expect.
5. **Extend to age 90** if you want to test longevity, and rebalance the later phases so nothing runs dry.
6. **Save the plan** when it looks right.

Most people find this genuinely satisfying rather than tedious. Adjusting a cash withdrawal here, a 401k withdrawal there, and watching the ending balances stay healthy turns an abstract worry into something you can see and control. If you would like a gentle, guided version of exactly this, the walkthrough of [your first planning session](/blog/your-first-retirement-planning-session.html) covers the same ground at a slower pace.
...
**Soft CTA:** Want to see a finished plan before you build your own? The interactive demo walks through a complete sample plan, phase by phase, with the taxes and healthcare costs already modeled.

**Demo CTA:** Open the demo and follow one sample plan from the first phase to the last. It shows how the setup you have just read about turns into a month-by-month income plan you can read at a glance.

**Product CTA:** The AI Retirement Income Planner models your retirement income across five phases, month by month, including taxes, healthcare, Social Security timing, withdrawals, and required distributions. One-time purchase, no subscription, no account, and your plan stays in your own browser.

## Internal Links To Add

- Forward links used in body: retirement-income-timeline-phases (301), retirement-ending-balance-that-carries-the-plan (303), gross-net-real-retirement-income (302), how-much-can-i-spend-in-retirement (019), keeping-your-retirement-plan-current (310), your-first-retirement-planning-session (311), how-to-compare-retiring-in-the-us-vs-abroad (120).
- Queued (targets not yet live): save-load-compare-retirement-scenarios (Post B, group of this series).
- Reciprocal backfills to add when convenient: 311 and 301 → this post (both are natural inbound partners for a getting-started hub).

## Facebook Post Snippets

**Snippet 1:** Setting up a retirement income plan is simpler than it looks. Enter your numbers once, then fine-tune your withdrawals right on the phase cards and watch the tax, healthcare, and ending balance update instantly. Here is the full step-by-step.

**Snippet 2:** The fastest way to a first retirement plan: use the setup wizard to get the essentials in about three minutes, then adjust phase by phase until every phase ends with a healthy balance. No account, no subscription, all in your browser.

**Snippet 3:** The number to watch when you build a retirement plan is the ending balance on each phase. It is what carries one phase into the next. If a later phase runs dry, pull back the earlier withdrawals until it holds.

## Newsletter Summary

This step-by-step guide shows how to set up a retirement income plan from the first screen to a finished, saved file. It covers the five-phase model and why retirement income is best treated as a sequence rather than one averaged year, the two-step workflow of entering figures in Edit values and then fine-tuning on the Overview phase cards, the Quick Setup Wizard as the fastest start, how to read the all-important ending balance, live editing with instant tax and healthcare feedback, currency and residency options, the Replan from today workflow for annual course corrections, the built-in help and education, and how to save and export your work. The planner runs privately in your browser with no account or subscription.
