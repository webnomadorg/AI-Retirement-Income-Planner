...
**SEO title:** How to Use the AI Co-Pilot  
**Meta description:** Learn how to use the AI Retirement Income Planner AI Co-Pilot, including AI Chat, Plan with AI, user-approved proposals, report commentary, privacy checks, and safe prompt workflows.  
**Primary keyword:** AI retirement planner co-pilot  
**Secondary keywords:** how to use AI co-pilot retirement planner, AI Chat retirement planner, Plan with AI sidebar, user-approved AI proposals, AI retirement planning workflow  
**Original plan reference:** Idea #140  
**Cluster:** Planner Features and Analysis Tools  
**Category:** AI & Retirement  
**Suggested URL slug:** how-to-use-the-ai-co-pilot  
**Image source base:** 140-how-to-use-the-ai-co-pilot  
**Published:** 2026-07-17  
**Calendar priority:** Post-calendar original 150-idea backlog  
**Content type:** planner feature tutorial and AI workflow guide

**Image 1 alt:** Illustration of an AI assistant presenting a retirement planning dashboard with a confidence gauge, charts, and plan cards
**Image 2 alt:** The Plan with AI sidebar showing six quick-start action chips and a box to ask about your plan
**Image 3 alt:** The AI Assistant sidebar open beside the Confidence tab, which shows a plan confidence score of 94 out of 100 with Ask AI buttons
**Image 4 alt:** Four-step workflow illustration: calculate the plan, ask AI to explain a result, approve the change, then rerun and compare

**Search intent:** The reader wants a practical walkthrough for using the planner's AI surfaces without asking AI to replace calculator output, official sources, or human review.  
**Product fit:** The AI Retirement Income Planner includes optional AI Chat for plan questions, plan review, Learn-the-planner mode, and proposal workflows; a Plan with AI sidebar for working alongside any planner tab; optional AI commentary in reports when AI is configured; user-approved AI proposals; user-supplied AI keys stored in the user's browser according to the selected key-storage mode; cloud AI provider support using the user's own API key; and local Ollama support without a cloud API key.  
**Educational disclaimer:** This article is for general education only. It is not financial, tax, investment, legal, healthcare, insurance, Social Security, Medicare, estate, privacy, cybersecurity, AI safety, software, or retirement advice. AI tools can produce incorrect, incomplete, outdated, or persuasive-sounding responses. Verify numbers with planner calculations, official sources, and qualified professionals before making decisions.
...
[IMAGE 140-how-to-use-the-ai-co-pilot 1]

## What The AI Co-Pilot Is For

The AI Co-Pilot is for explanation, review, and structured planning support. It is the practical companion to [how an AI co-pilot can explain a retirement plan](/blog/how-an-ai-co-pilot-can-explain-a-retirement-plan.html).
...
[IMAGE 140-how-to-use-the-ai-co-pilot 2]

## Before You Turn On AI

Before configuring AI, decide what setup you want. The walkthrough on [using AI in the retirement planner](/blog/using-ai-in-the-retirement-planner.html) covers choosing a provider and storing your key.
...
Before using AI with sensitive information, follow the basics of [how to use AI safely for retirement planning](/blog/how-to-use-ai-safely-for-retirement-planning.html):
...
That kind of prompt keeps the AI grounded, especially once you know [how to use Plan Health](/blog/how-to-use-plan-health-ai-retirement-income-planner.html) and can name the exact check.
...
1. Update the planner inputs.
2. Run the plan.
3. Review Plan Health and Plan Confidence.
4. Open AI Chat.
5. Ask one specific question.
6. Ask for assumptions to verify.
7. Ask what scenario to test next.
8. Make changes in the planner, not in the chat.
9. Rerun the planner.
...
[IMAGE 140-how-to-use-the-ai-co-pilot 3]
...
1. Open the tab you are working on.
2. Ask AI to explain the current result.
3. Ask what input might be driving the result.
4. Ask for one change to test.
5. Review the proposed change.
6. Approve only if it matches your intent.
7. Rerun the planner.
...
[IMAGE 140-how-to-use-the-ai-co-pilot 4]
...
**Soft CTA:** The AI Co-Pilot is most useful when it explains calculated planner output. Use it to understand Plan Health, scenarios, taxes, healthcare, Social Security timing, reports, and assumptions before testing changes.
...
- Headline: How to Use the AI Co-Pilot
- Description: Tutorial on using the AI Retirement Income Planner AI Co-Pilot safely and practically.
- Keywords: AI retirement planner co-pilot, AI Chat retirement planner, Plan with AI sidebar, user-approved AI proposals
- Mentions: AI Retirement Income Planner, AI Chat, Plan with AI, Plan Health, Plan Confidence, user-approved AI proposals, Ollama, API key, report commentary
...
**Snippet 1:** The safest AI retirement workflow is calculator first, AI explanation second, user approval third. Let the planner calculate before asking AI to explain.

**Snippet 2:** Use AI Chat for focused questions and Plan with AI when you want help beside a planner tab. In both cases, review proposed changes before accepting anything.

**Snippet 3:** AI is useful for explaining Plan Health, scenarios, reports, and missing assumptions. It should not replace official sources, planner math, or professional review.
