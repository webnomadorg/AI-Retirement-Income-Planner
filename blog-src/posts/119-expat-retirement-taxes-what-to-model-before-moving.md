# Expat Retirement Taxes: What to Model Before Moving

**SEO title:** Expat Retirement Taxes: What to Model Before Moving  
**Meta description:** Expat retirement taxes can affect Social Security, IRA withdrawals, pensions, foreign accounts, currency conversion, healthcare, and return-to-US scenarios. Here is what to model before moving.  
**Category:** Expat & International

**Published:** 2026-09-02

**Suggested URL slug:** expat-retirement-taxes-what-to-model
...
**Primary keyword:** expat retirement taxes  
**Secondary keywords:** US retiree abroad taxes, foreign tax credit retirement, FBAR retirement abroad, Form 8938 expats, retirement taxes before moving abroad  
**Original plan reference:** Idea #118  
**Cluster:** Expat and International Retirement  
**Calendar priority:** Post-calendar original 150-idea backlog  
**Content type:** expat tax modeling checklist and product-led tutorial

**Search intent:** The reader is considering retirement abroad and wants to know which tax and reporting items should be modeled before moving.  
**Product fit:** The AI Retirement Income Planner supports seven currencies, residency-aware planning, US-taxpayer settings, UK Foreign Tax Credit handling, foreign-residence scenarios, custom exchange rates, saved scenarios, Stress Test, Plan Health checks, and Plan Confidence.  
**Educational disclaimer:** This article is for general education only. It is not financial, tax, investment, legal, immigration, visa, privacy, cybersecurity, healthcare, insurance, Social Security, Medicare, estate, AI safety, software, or retirement advice. Expat retirement taxes can involve US federal tax, state residency, foreign tax, treaties, account reporting, currency conversion, healthcare, Social Security, estate planning, and local filing rules. Verify details with IRS, foreign tax authorities, treaty text, and qualified professionals.
...
[IMAGE 119-expat-retirement-taxes-what-to-model-before-moving 1]
...
[IMAGE 119-expat-retirement-taxes-what-to-model-before-moving 3]
...
**Soft CTA:** Before moving abroad, build a tax-aware version of the retirement plan, not merely a cost-of-living budget.  

**Product CTA:** The AI Retirement Income Planner helps compare US baseline, foreign-residence, higher-tax, and return-to-US scenarios with seven currencies, custom exchange rates, healthcare assumptions, Stress Test, Plan Health checks, and Plan Confidence.  

**Download CTA:** Use the planner to organize the questions you need answered before making a cross-border retirement move.
...
**Snippet 1:**  
Retiring abroad is bigger than a cost-of-living decision. Model Social Security, IRA withdrawals, foreign account reporting, currency conversion, healthcare, and a return-home case before moving.

**Snippet 2:**  
The foreign earned income exclusion gets attention, but retirees need to know it does not cover pension or annuity payments, including Social Security benefits.

**Snippet 3:**  
An expat retirement plan should include a US baseline, foreign-residence base case, higher-tax case, and return-to-US case. The differences can be eye-opening.

## Newsletter Summary

This article explains what US retirees should model before moving abroad, including worldwide income, retirement-account withdrawals, Social Security, foreign tax credits, foreign earned income limits, FBAR, Form 8938, currency conversion, state residency, healthcare, and return-to-US scenarios. It shows how the AI Retirement Income Planner can organize those assumptions before professional review.
