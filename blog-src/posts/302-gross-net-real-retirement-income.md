...
**Meta description:** A single monthly income target is a starting point, not a plan. Here is how to break it into gross, net, and real income, separate reliable income from flexible withdrawals, and see what your money will actually buy.

**Suggested URL slug:** gross-net-real-retirement-income

**Image source base:** gross-net-real-retirement-income

**Lead image:** 1

**Image 1 alt:** Editorial illustration of a single monthly income figure separating into gross, net, and real income, with a reliable-income floor beneath flexible withdrawals.

**Image 2 alt:** A planner phase card showing gross income, net income after taxes and healthcare, and real income in today's dollars, with the real-versus-nominal popover open.

**Primary keyword:** net retirement income

**Secondary keywords:** gross vs net retirement income, real vs nominal income, reliable vs flexible income, retirement income floor, spendable retirement income
...
That difference can be large enough to change a decision. A plan showing $5,000 a month *before* tax feels very different from one that produces $5,000 a month *after* tax and healthcare. This is the heart of [how much you can actually spend in retirement](/blog/how-much-can-i-spend-in-retirement.html).
...
The point is not that one retiree is automatically better off. The point is that the **same monthly income can carry different consequences depending on where it comes from**, which is exactly why [the order you draw from your accounts](/blog/which-retirement-account-withdraw-from-first.html) is a real planning decision, not an afterthought.
...
This is also why [when you claim Social Security](/blog/claim-social-security-at-62-or-wait.html) is really a question about how tall you want your income floor to be for the rest of your life.
...
That produces a far clearer picture than one average retirement income number. One plan might show strong net income from 67 onward but a weak stretch from 62 to 65 before Medicare and Social Security, which points to the [bridge years before Medicare](/blog/can-i-retire-at-62-before-medicare.html) needing attention. Another might show good income early but falling *real* income later, which points to inflation risk. Those are different problems with different fixes, and you can only tell them apart when the income is broken into its parts.
...
[IMAGE planner phase card gross net real income with real popover 2]
...
**Soft CTA:** Want to see gross, net, and real income side by side? The interactive demo shows a full sample plan where each phase card breaks the monthly number into what comes in, what is spendable, and what it is worth in today's money.

**Demo CTA:** Open the live demo, look at a phase card on the Overview tab, and hover the real-income figure to see how inflation changes the picture.

**Product CTA:** The AI Retirement Income Planner turns your own numbers into gross, net, and real income for every phase, separates your guaranteed income floor from flexible withdrawals, checks income adequacy, and lets you compare saved plans. One-time purchase, no subscription, runs privately in your browser.

## Facebook Post Snippets

**Snippet 1:** "$3,000 from your 401(k) plus $2,000 from Social Security" is $5,000 of gross income, but it is not $5,000 you can spend. What matters for your lifestyle is net income, after taxes and healthcare. The monthly number is only the start.
...
A single monthly income target is a useful starting point but a poor stopping point. This article breaks the number into the parts that actually decide whether a plan works: gross versus net income (what comes in versus what is spendable after taxes and healthcare), nominal versus real income (future dollars versus today's purchasing power), and reliable versus flexible income (a guaranteed floor from Social Security and pensions versus withdrawals from your portfolio). The same $4,500 can behave very differently depending on the source and the phase. It also shows how the planner displays gross, net, and real income on every phase card, separates your guaranteed income floor from flexible withdrawals, and checks income adequacy against a floor you set.
