...
**SEO title:** What Is MAGI in Retirement Planning?  
**Meta description:** MAGI, or modified adjusted gross income, can affect ACA Marketplace savings, Medicare IRMAA, Social Security taxation, Roth conversions, and retirement withdrawals.  

**Category:** Taxes & Roth

**Published:** 2026-09-02

**Suggested URL slug:** what-is-magi

**Image 1 alt:** Editorial illustration of one wide river of income passing through a gate and splitting into three separate channels, each with its own gate at a different point, running to a medical cross, a shield and a government building.

**Image 2 alt:** A planner phase card showing one MAGI figure driving three outcomes at once: ACA subsidy eligibility above 100 percent of the federal poverty level, cost-sharing reductions lost above 250 percent, and an IRMAA proximity warning that this MAGI will set a later phase's Medicare premiums.

**Primary keyword:** what is MAGI  
**Secondary keywords:** modified adjusted gross income retirement, MAGI retirement planning, ACA MAGI, Medicare IRMAA MAGI, Roth conversion MAGI, retirement income MAGI  
**Original plan reference:** Idea #146  
**Cluster:** Glossary and Short Answer Pages  
**Calendar priority:** Post-calendar original 150-idea backlog  
**Content type:** glossary explainer and planner workflow

**Search intent:** The reader wants a plain-English definition of MAGI and why it matters for retirement income planning.  
**Product fit:** The AI Retirement Income Planner includes Tax & ACA tools, ACA premium and FPL threshold modeling, Medicare IRMAA threshold and two-year lookback behavior, Social Security taxation context, Roth conversion modeling, RMD estimates, withdrawal scenarios, Plan Health checks, Plan Confidence, and report preview.  
**Educational disclaimer:** This article is for general education only. It is not financial, tax, investment, legal, healthcare, insurance, Social Security, Medicare, estate, AI safety, software, or retirement advice. MAGI definitions vary by program and rule. Verify tax, ACA Marketplace, Medicare, Social Security, and planning decisions with official sources and qualified professionals.
...
That timing can affect Marketplace income estimates before Medicare begins. The cost-sharing side of this is covered in more depth in [ACA Silver plan cost-sharing reductions](/blog/aca-silver-plan-cost-sharing-reductions.html), and the wider picture in [taxes, ACA subsidies and healthcare in early retirement](/blog/taxes-aca-healthcare-early-retirement.html).
...
In the planner, review Medicare and IRMAA-sensitive years when testing Roth conversions, RMD pressure, taxable-account sales, or survivor scenarios. Conversions are the lever most likely to move this number, which is the subject of [Roth conversions before RMDs](/blog/roth-conversions-before-rmds.html).
...
The planner's tax views can help show when Social Security timing and withdrawal timing interact, and [how taxes change retirement income](/blog/how-taxes-change-retirement-income.html) walks through that interaction in full.
...
1. Enter current income, spending, balances, and healthcare assumptions.
2. Open or review the Tax & ACA area.
3. Save a base plan.
4. Identify MAGI-sensitive years: ACA years, Medicare years, RMD years, Roth conversion years, and survivor years.
5. Create one scenario at a time.
6. Change one income item, such as a Roth conversion or withdrawal amount.
7. Review tax, ACA, Medicare, IRMAA, RMD, balance, Plan Health, and Plan Confidence results.
8. Save notes explaining what changed.
9. Verify current rules with official sources and qualified professionals.

[IMAGE 146-what-is-magi 2]
...
**Soft CTA:** MAGI is easier to understand when it is connected to real retirement choices. The AI Retirement Income Planner lets you test withdrawals, Roth conversions, Social Security timing, ACA years, Medicare years, RMDs, and Plan Health together.

**Product CTA:** Use the AI Retirement Income Planner when you want a private, browser-based way to review MAGI-sensitive scenarios across taxes, ACA Marketplace planning, Medicare IRMAA, Roth conversions, RMDs, withdrawal order, and retirement confidence.

**Demo CTA:** Try a demo scenario, add a Roth conversion or IRA withdrawal, and review how the Tax & ACA area changes before and after the adjustment.

## Schema Notes

- Suggested schema type: Article
- Suggested secondary schema: FAQPage
- Suggested product mention: AI Retirement Income Planner
- Suggested author entity: AI Retirement Income Planner
- Suggested audience: early retirees, Medicare-age retirees, Roth conversion planners, ACA Marketplace users, retirement software shoppers
- Suggested about topics: MAGI, modified adjusted gross income, ACA Marketplace income, Medicare IRMAA, Social Security taxation, Roth conversions, RMDs, retirement tax planning
...
**Snippet 1:** MAGI is one of those retirement terms that shows up everywhere: ACA, Medicare IRMAA, Social Security taxation, Roth conversions, and RMD planning.

**Snippet 2:** A Roth conversion can look good in a tax bracket and still change MAGI-sensitive healthcare planning. Model the whole year before deciding.

**Snippet 3:** MAGI does not mean the same thing in every rule. Marketplace MAGI, Medicare IRMAA MAGI, and Social Security tax calculations each need their own review.

## Newsletter Summary

MAGI stands for modified adjusted gross income. It usually starts with AGI and then adds back certain items for a specific tax rule or program. In retirement planning, MAGI can affect ACA Marketplace savings, Medicare IRMAA, Social Security taxation, Roth conversions, RMDs, withdrawal order, and taxable account sales. The planner's Tax & ACA tools help users compare MAGI-sensitive scenarios before verifying current rules with official sources.
