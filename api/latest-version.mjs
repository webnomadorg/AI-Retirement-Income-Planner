...
const LATEST = { build: 285, released: '2026-08-06', headline: 'Medicare and IRMAA priced properly: all six income brackets, and both spouses when you are married.' }; /* __LATEST__ */
