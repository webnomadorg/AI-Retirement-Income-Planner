/* Sitewide sale banner — the shared state file.
   ...
   tier an occasion is, and that table lives in tools/testimonials/sales.mjs — console code that
...
export const AUTO_DEFAULTS = {
  ...
  minGapDays: 21,       // a MINT-time rule; recorded here so the console has one home for it
